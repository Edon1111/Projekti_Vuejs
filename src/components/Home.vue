      ...
      <section id="about">
        <div class="row">
          <div class="column">
            ...
            <div class="p">
              <h4 style="padding-left:15px; color: #787878;">
          ...
          <div class="column">
            <img
              src="https://powping.com/file/9c3a26bb37764d887fcef6646e4f237aa7995a2a21abdfb6e0591d87d063bc65"
        ...
        <v-layout column wrap class="my-5" align-center>
          <v-flex xs12 sm4 class="my-3">
            <div class="text-xs-center">
              <h2 class="headline">
                The best place to enjoy the most amazing movies
              </h2>
                ...
                <v-flex xs12 md4>
                  <v-card class="elevation-0 transparent">
                    <v-card-text class="text-xs-center">
                      <v-icon x-large class="red--text text--darken-4"
                        >mdi-movie-play</v-icon
                      >
                    </v-card-text>
                    <v-card-title primary-title class="layout justify-center">
                      <div class="headline text-xs-center">
                        Download your best movies and watch it everywhere.
                      </div>
                    </v-card-title>
                    <v-card-text>
  ...
  data() {
    return {
      photo: [
        {
          src:
            "https://cdn.thetealmango.com/wp-content/uploads/2021/09/expensive-films.jpg"
        },
        {
          src:
            "https://images.summitmedia-digital.com/esquiremagph/images/2020/04/07/Top-Rated-Trinity-01.jpg"
        },
        {
          src:
            "https://images.squarespace-cdn.com/content/v1/51b3dc8ee4b051b96ceb10de/1579830754870-9IAYNSOR0S7TP5SKI9VR/image-asset.jpeg"
        },
        {
